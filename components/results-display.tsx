    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="summary" value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid grid-cols-2 md:grid-cols-5 mb-6">
          ...
          <TabsTrigger value="decisions" className="data-[state=active]:bg-teal-600 data-[state=active]:text-white">
            <CheckCircle className="mr-2 h-4 w-4" />
            Decisioni
          </TabsTrigger>
          <TabsTrigger value="tasks" className="data-[state=active]:bg-teal-600 data-[state=active]:text-white">
            <ListTodo className="mr-2 h-4 w-4" />
            Task
          </TabsTrigger>
          <TabsTrigger value="themes" className="data-[state=active]:bg-teal-600 data-[state=active]:text-white">
            <Hash className="mr-2 h-4 w-4" />
            Temi
          </TabsTrigger>
          <TabsTrigger value="participants" className="data-[state=active]:bg-teal-600 data-[state=active]:text-white">
            ...
            <CardContent>
              <div className="flex flex-wrap gap-2">
                {results.themes.map((theme, index) => (
                  <Badge key={index} variant="secondary" className="text-sm py-1.5 px-3 bg-teal-100 text-teal-800">
                    {theme}
                  </Badge>
                ))}
              </div>
